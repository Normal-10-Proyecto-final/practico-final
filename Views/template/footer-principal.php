  <div id="myModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="my-modal-title" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header" style="background-color:rgb(230, 150, 3);">
          <h5 class="modal-title" style="color:#ffff;"><i class="fas fa-cart-arrow-down"></i>Carrito</h5>
  ...
  <div id="modalLogin" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="my-modal-title" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header" style="background-color:rgb(230, 150, 3);">
          <h5 class="modal-title" style="color:#ffff;" id="titleLogin">Iniciar Sesion</h5>
          <button class="btn-close" data-bs-dismiss="modal" aria-label="Close">
          </button>
        </div>
          ...
          <form method="get" action="">
            ...
            <div class="row">
              <div class="col-md-12" id="frmLogin">
                ...
                <div class="float-end">
                  <button class="btn btn-warning text-light btn-lg" type="button" id="login">Login</button>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-12 d-none" id="frmRegister">
              ...
              <div class="float-end">
              <button class="btn btn-warning text-light btn-lg" type="button" id="registrarse">Registrarse</button>       
            </div>
            </div>
          </form>
        </div>
