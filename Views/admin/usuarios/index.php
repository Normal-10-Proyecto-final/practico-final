...
<div class="card">
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-bordered table-striped table-hover" style="width:100%;" id="tblUsuarios" name="tblUsuarios">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>Nombres</th>
            ...
            <form id="frmRegistro">
                <div class="modal-body">
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input id="correo" class="form-control" type="email" name="correo" placeholder="Correo@Ejemplo.com">
                    </div>
                    <div class="form-group mb-2">
