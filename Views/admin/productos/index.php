        ...
        <div class="card">
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-hover align-middle" style="width:100%;" id="tblProductos" name="tblProductos">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Nombres</th>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea id="descripcion" class="form-control" name="descripcion" rows="3" placeholder="Descripcion del producto"></textarea>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
