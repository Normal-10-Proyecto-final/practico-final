...
<body>
    <!-- Start Top Nav -->
    <nav class="navbar navbar-expand-lg  bg-gradient navbar-light d-none d-lg-block" id="templatemo_nav_top" style="background-color: rgb(184, 123, 11);">
        <div class="container text-dark">
            <div class="w-100 d-flex justify-content-between">
                <div>
                    <i class="fa fa-envelope mx-2"></i>
                    <a class="navbar-sm-brand text-dark text-decoration-none" href="mailto:info.Ozymandias@gmail.com">info.Ozymandias@gmail.com</a>
                    <i class="fa fa-phone mx-2"></i>
                    <a class="navbar-sm-brand text-dark text-decoration-none" href="tel:+54 3764 251775">+54 3764 251775</a>
                </div>
                <div>
                    <a class="text-dark" href="https://fb.com/templatemo" target="_blank" rel="sponsored"><i class="fab fa-facebook-square fa-sm fa-fw me-2"></i></a>
    ...
    <!-- Header -->
    <nav class="navbar navbar-expand-lg navbar-light shadow" style="background-color: rgb(230, 150, 3);">
        <div class="container d-flex justify-content-between align-items-center">

            <a class="navbar-brand text-light logo h3 align-self-center" href="<?php echo BASE_URL; ?>">
                <?php echo TITLE; ?>
            </a>
            ...
            <div class="align-self-center collapse navbar-collapse flex-fill  d-lg-flex justify-content-lg-between" id="templatemo_main_nav">
                <div class="flex-fill">
                    <ul class="nav navbar-nav d-flex justify-content-between mx-lg-auto">
                        <li class="nav-item">
                            <a class="nav-link " style="color:white;" href="<?php echo BASE_URL . 'principal/about'; ?>">Nosotros</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" style="color:white;" href="<?php echo BASE_URL . 'principal/shop/'; ?>">Comprar</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" style="color:white;" href="<?php echo BASE_URL . 'principal/contactos'; ?>">Contacto</a>
                        </li>
                    </ul>
                </div>
                <div class="navbar align-self-center d-flex">
                    ...
                    <a class="nav-icon position-relative text-decoration-none<?php echo ($data['perfil'] == 'no') ? ' ' : 'd-none'; ?>" href="#" id="verCarrito">
                        <i class="fas fa-fw fa-cart-arrow-down text-light mr-1"></i>
                    ...
                    <a class="nav-icon position-relative text-decoration-none<?php echo ($data['perfil'] == 'no') ? ' ' : 'd-none'; ?>" href="<?php echo BASE_URL . 'principal/deseo' ?>">
                        <i class="fas fa-fw fa-heart text-light mr-1"></i>
                    ...
                    <?php } else { ?>
                        <a class="nav-icon position-relative text-decoration-none" href="#" data-bs-toggle="modal" data-bs-target="#modalLogin">
                            <i class="fas fa-fw fa-user text-light mr-3"></i>
                        </a>
                    <?php } ?>
